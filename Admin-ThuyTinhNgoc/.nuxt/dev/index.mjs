...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/devalue/index.js';
import destr from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/vue/index.mjs';
import { basename, isAbsolute } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/unstorage/drivers/fs.mjs';
import { collections } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/ipx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/node_modules/@unhead/shared/dist/index.mjs';
...
const _jUuYcONB6k = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc";
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "baseURLAPI": "http://127.0.0.1:8000"
  },
  "icon": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\ThuyTinhNgoc\\Admin-ThuyTinhNgoc","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\ThuyTinhNgoc\\Admin-ThuyTinhNgoc\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\ThuyTinhNgoc\\Admin-ThuyTinhNgoc\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\ThuyTinhNgoc\\Admin-ThuyTinhNgoc\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\ThuyTinhNgoc\\Admin-ThuyTinhNgoc\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _tCaDdI = defineCachedEventHandler(async (event) => {
...
const _agHP8f = lazyEventHandler(() => {
...
const _lazy_Gbl5go = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Gbl5go, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _tCaDdI, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _agHP8f, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Gbl5go, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/ThuyTinhNgoc/Admin-ThuyTinhNgoc/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
